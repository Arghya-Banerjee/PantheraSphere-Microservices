...
function RegisterPage() {
  return (
    <>
      <Navbar />
      <main className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-white p-5">
        <div
          className="bg-white rounded-2xl shadow-2xl p-8 max-w-xl w-full text-blue-800 flex flex-col items-center"
          role="main"
          aria-label="PantheraSphere registration form"
          style={{ minHeight: "560px", maxWidth: "640px" }}
        >
          <h1
          ...
          <p className="text-blue-600 text-lg italic font-medium mb-6 text-center">
            Join the community. Create your account below.
          </p>
